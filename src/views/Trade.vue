  ...
  <div class="container mt-5">
    <div class="card has-background-primary-light">
      <div class="card-content">
        ...
        <div class="content">
          Hi my name is Mr. Cat, and I would like to trade minecraft items.
